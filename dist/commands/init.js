...
import { getDestinationPath, getRelativePath, validateFrontmatter, writeFileAtomic, createBackup, } from '../sync/copy.js';
import { readState, writeState, isInstalled } from '../state/state.js';
import { errorUnknownKind, errorFrontmatterInvalid, errorNameConflict, } from '../errors.js';
...
export async function runInit(options = {}) {
    ...
    try {
        ...
        for (const entry of manifest.entries) {
            ...
            if (!byDestination[destLabel])
                byDestination[destLabel] = [];
