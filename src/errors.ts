export function errorUnknownKind(kind: string): string {
  return [
...
export function errorNetworkDown(subcommand: string): string {
  return [
...
export function errorManifestInvalid(): string {
  return [
...
export function errorVersionHandshake(current: string, required: string): string {
  return [
...
export function errorPermissions(path: string): string {
  return [
...
export function errorStackInvalid(name: string, missingField: string): string {
  return [
...
export function errorFrontmatterInvalid(name: string): string {
  return [
...
export function errorNameConflict(name: string): string {
  return [
...
export function errorFileDownloadFailed(source: string, status: number): string {
  return [
