import { parseArgs, getHelpText, getSubcommandHelpText, getInvalidSubcommandMessage, type Subcommand } from './cli.js';
...
async function main(): Promise<void> {
  ...
  if (!parsed.subcommand || parsed.showHelp) {
    ...
    console.log(getSubcommandHelpText(parsed.subcommand as Subcommand));
    process.exit(0);
    return;
  }
